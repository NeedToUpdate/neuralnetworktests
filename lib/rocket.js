class Rocket {
    ...
    switch(pos, bool) {
        this.gfx.rockets[pos].set(
            "border",
            (bool ? "red" : "black") + " solid 1px"
        );
    ...
    draw() {
        ...
        this.body.shape.style.transform =
            "rotate(" + this.fw.getAngle() + "deg)";
    }
    ...
    isOOB() {
        ...
        return (
            this.p.x > this.canvasSize.x ||
            this.p.x < 0 ||
            this.p.y < 0 ||
            this.p.y > this.canvasSize.y ||
            hit
        );
    }
